...
class NaviActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val endNavigationButton: Button = findViewById(R.id.btn_end_navigation)
        endNavigationButton.setOnClickListener {
            val intent = Intent(this@NaviActivity, MapActivity::class.java)
            startActivity(intent)
            finish()  // NaviActivity를 종료하고 MapActivity로 돌아갑니다.
        }
                        ...
                        if(topic == "/gps"){
                            ...
                            runOnUiThread {
                                if (currentMarker == null) {
                                    ...
                                    val width = (originalBitmap.width * 0.06).toInt()  // 여기에서 0.5는 50% 크기를 의미합니다.
                                    val height = (originalBitmap.height * 0.06).toInt()
